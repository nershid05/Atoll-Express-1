                  ...
                  {selectedTripId > 0 && availability && (
                    availability.remaining === 0 ? (
                      <div className="rounded-xl border border-red-200 bg-red-50 p-4 text-center space-y-2">
                        <p className="text-red-700 font-semibold text-sm">All online seats for this trip are fully booked.</p>
                        <p className="text-red-600 text-sm">Please contact us directly to check for availability.</p>
                        <a
                          href="tel:+9607771234"
                          className="inline-flex items-center gap-2 mt-1 px-5 py-2.5 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg text-sm transition-colors"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3-8.59A2 2 0 0 1 3.77 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.75a16 16 0 0 0 6.29 6.29l1.1-1.1a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                          Call +960 777-1234
                        </a>
                      </div>
                    ) : (
